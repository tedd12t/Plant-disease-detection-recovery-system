...
TRANSLATIONS = {
    ...
    "ti": {
        ...
        "about_dataset_description": "እቲ ሞዴል ኣስታት 87,000 ዝኾኑ ናይ RGB ናይ ተኽሊ ቆጽሊ ስእልታት ዘለዎ ሰፊሕ ዳታሴት ተጠቒሙ ሰልጢኑ። እዚ ዳታሴት 37 ዝተፈላለዩ ክፍለታት ዝሽፍን ኮይኑ፡ እዚኦም ድማ ዝተፈላለዩ ሕማማትን ጥዑያት ናይ ተኽሊ ቆጽልን ኣብ ዝተፈላለዩ ዓይነታት ሰብሊ የጠቓልሉ። እቲ ዳታ ብጥንቃቐ ቅድመ-መስርሕ ተገይሩሉ (ስፍሓቱ ተስተኻኺሉ፡ መደበኛ ኮይኑ) ከምኡ'ውን ርግጸኛ ናይ ሞዴል ምምሃርን ገምጋምን ንምርግጋጽ ናብ ናይ ስልጠናን መረጋገጺን ስብስባት ተመቓቒሉ። ኣጠቃላይነት ንምምሕያሽ ናይ ምዕባይ ቴክኒካት እውን ተፈቲኖም።",
